...
function processInput(input) {
    ...
    if (text.includes("historia")) response = botResponses.historia;
    else if (text.includes("liga")) response = botResponses.ligas;
    else if (text.includes("jugadora") || text.includes("cracks")) response = botResponses.jugadoras;
    else if (text.includes("balón") || text.includes("oro")) response = botResponses.balon;
